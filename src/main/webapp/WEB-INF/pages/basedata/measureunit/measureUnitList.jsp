			...
			<div class="panel">
				...
				<div class="panel-body" style="padding: 0px 2px 2px 2px;">
					<table id="tblMain">
						 <thead >
							<tr>
								<th data-field="unitClass" data-type="select">分类</th>
...
function beforeAction(opt){
	if(opt=='addnew'){
		...
		if(!webUtil.isEmpty(params)&&!webUtil.isEmpty(params.tree)
			...
			webUtil.mesg('请先选择具体的单位分类，然后才能做新增操作!');
			return false;
		}
	}
	return true;
...
$(document).ready(function() {
     ...
     var editWin ={title:'计量单位',width:620,height:320};
     var treeOpt = {setting:{data: {
         	simpleData: {enable:false,idKey: "id"}
    	 }}};
     var height = top.getTopMainHeight()-45;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'base/measureunits/treeData'
    	 ,baseUrl:'base/measureunits',title:'计量单位',height:height,
