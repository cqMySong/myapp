	...
	<div id="table-toolbar" style="height:40px;padding-top: 2px;">
		<div class="col-sm-3">
			<div class="input-group">
				<span class="input-group-addon lable">整改单位</span>
	...
	<div class="mainContrainer">
		...
		<div class="rightContainer" id="main_container">
			<table id="tblMain">
				<thead >
					<tr>
						<th data-field="rectifyNoticeNumber">编号</th>
						<th data-field="orgUnit">整改单位</th>
						<th data-field="rectifyNoticeAttach" data-formatter="rectifyNoticeAttach">链接整改原件</th>
						<th data-field="isFeedBack" data-formatter="isFeedBack">整改回复</th>
						<th data-field="feedBackAttach" data-formatter="feedBackAttach">链接整改回复原件</th>
					</tr>
				</thead>
			</table>
		</div>
...
<script type="text/javascript">
    ...
    function isFeedBack(value, row, index){
        return value==true?"已回复":"未回复";
    }
    function rectifyNoticeAttach(value, row, index){
        return "<a href=\"javascript:webUtil.showAttach('"+row["rectifyNoticeId"]+"','整改原件');\">"+value+"</a>";
	}
    function feedBackAttach(value, row, index){
        return "<a href=\"javascript:webUtil.showAttach('"+row["feedBackId"]+"','整改回复原件');\">"+value+"</a>";
    }
    ...
    function initTable(){
        ...
        var table_options = {height:height,striped:true,sortStable:false,showRefresh:false,selectModel:1
            ...
            ,showColumns:false,idField:"id",mypagination:true,url:'ec/other/rectifynoticeledger/query'};
