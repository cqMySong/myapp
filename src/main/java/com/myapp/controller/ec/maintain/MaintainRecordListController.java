...
@Controller
@RequestMapping("ec/maintain/maintainrecords")
public class MaintainRecordListController extends BaseListController {
	...
	public String getEditUrl() {
		return "ec/maintain/maintainRecordEdit";
	}

	public String getListUrl() {
		return "ec/maintain/maintainRecordList";
	}
}
