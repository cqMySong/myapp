	...
	<div id="editPanel" class="panel">
		...
		<form id="editForm">
			<div class="row">
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">受奖单位</span> 
				...
				<div class="col-sm-6 mb15">
					<div class="input-group">
						...
						<input name="rewardPunishTypeInfo" class=" input-item form-control" 
							data-opt="{type:'f7',uiWin:{title:'奖励类别',height:400,width:500,url:'ec/other/rewardtypeF7'}}" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">授予日期</span>
						<input class="input-item form-control require" name="grandDate" data-opt="{type:'date'}">
					</div>
				</div>
				<div class="col-sm-6 mb15">
					<div class="input-group">
						<span class="input-group-addon lable">颁奖单位</span>
			...
			<div class="row mt10">
				<div class="col-sm-12">
					<div class="input-group">
						<span class="input-group-addon lable">奖励事项</span> 
			...
			<div class="row mt10">
				<div class="col-sm-12">
					<div class="input-group">
						<span class="input-group-addon lable">奖励办法</span>
