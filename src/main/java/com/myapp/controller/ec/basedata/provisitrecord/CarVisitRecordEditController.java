...
@Controller
@RequestMapping("ec/basedata/carvisitrecord")
public class CarVisitRecordEditController extends BaseEditController{
	...
	protected void beforeStoreData(BaseMethodEnum bme, Object editData) {
		...
		if(editData!=null&&editData instanceof ProVisitRecordInfo){
			...
			pvrInfo.setVisitType(VisitType.CAR);
		}
	}
	...
	protected void initDefDataValue(Object editData) {
		...
		if(editData!=null&&editData instanceof ProVisitRecordInfo){
			...
			odrInfo.setVisitType(VisitType.CAR);
		}
	}
