...
$(document).ready(function() {
     ...
     var editWin ={title:'施工现场检查目录',width:620,height:300,id:"proeccheckdata_tab"};
     var treeOpt = {setting:{data: {
         	simpleData: {enable:true,idKey: "id", pIdKey: "parentId",rootPId: ''}
    	 }}};
     var height =  top.getTopMainHeight()-45;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/proresourcedata/eccheckdatas',title:'工程项目',height:height,
