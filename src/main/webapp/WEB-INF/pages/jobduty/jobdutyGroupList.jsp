					...
					<table id="tblMain">
						 <thead>
							<tr>
								...
								<th data-field="remark" data-width="300">备注</th>
							</tr>
						</thead>
					</table>
				</div>
...
$(document).ready(function() {
     ...
     var editWin ={title:'工作职责分组',width:620,height:300};
     var height = top.getTopMainHeight()-48;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',baseUrl:'base/jobdutygroups',title:'工作职责分组',height:height,
