...
@Controller
@RequestMapping("ec/stock/backs")
public class MaterialLeaseBackListController extends BaseListController {
    @Resource
    private MaterialLeaseBackService materialLeaseBackService;

    @Override
    public String getEditUrl() {
        return "ec/stock/back/backEdit";
    }

    @Override
    public String getListUrl() {
        return "ec/stock/back/backList";
    }
