		...
		<div>
			<div class="panel panel-success">
				<div class="panel-heading" style="padding: 13px;">
					<h3 class="panel-title">选择施工样板清单标准</h3>
...
<script type="text/javascript">
    ...
    var treeUrl = 'ec/basedata/constructiontemplates/treeData';
    $(document).ready(function(){
        leftTreeViewer = $('#allTreeItems').myTreeViewer(null);
        leftTreeViewer.init({title:'施工样板清单标准',height:470});
    ...
    function loadLeftTreeData(){
        ...
        webUtil.ajaxData({url:url,async:false,data:{code:'safedata'},success:function(data){
            treeDatas = data.data;
