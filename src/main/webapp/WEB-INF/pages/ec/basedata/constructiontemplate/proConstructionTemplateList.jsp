...
<div id="table-toolbar" class="panel" style="height:40px;padding-top: 1px;margin-bottom: 5px;">
	<div class="btn-group">
		<button class="btn btn-success" type="button" id="batchimp">
			<span class="fa fa-file-o"></span>&nbsp;施工样板清单导入</button>
	</div>
</div>
			...
			<div class="panel-body" style="padding: 0px 2px 2px 2px;">
				<table id="tblMain">
					...
					<tr>
						...
						<th data-field="content">配合的技术交底</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/basedata/proconstructiontemplates',title:'工程项目',height:height,
        ...
        $('#batchimp').on('click',function(){
            ...
            var _win = $.extend(true,{},{title:'施工样板清单导入',width:900,height:570,
                    ...
                    if(layero){
                        if(index==1){
                            ...
                            if(!webUtil.isEmpty(datas)&&datas.length>0){
                                ...
                                webUtil.ajaxData({url:"ec/basedata/proconstructiontemplate/batch/import",data:pams,async:true,success:function(data){
            ...
            _win.url =  webUtil.toUrl('ec/basedata/proconstructiontemplates/batch/import');
