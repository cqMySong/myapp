	...
	<div id="editPanel" class="panel">
		...
		<form id="editForm">
			...
			<div class="row mt10">
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">车辆类别</span> 
						<input name="carType" class="require input-item form-control"  />
					</div>
				</div>
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">牌照号</span> 
						<input name="carNo" class="require input-item form-control"  />
					</div>
				</div>
			</div>
			<div class="row mt10">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var editUI = $('#editPanel').editUI({
			title : "到访车辆记录",
			baseUrl : "ec/basedata/carvisitrecord",
