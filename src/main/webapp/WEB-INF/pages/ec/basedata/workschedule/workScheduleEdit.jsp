			...
			<div class="row">
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">工作安排编号</span>
			...
			<div class="row mt10">
				...
				<div class="col-sm-6">
					<div class="input-group">
						...
						<input name="personLiable" class="require input-item form-control"/>
					</div>
				</div>
			</div>
			<div class="row mt10">
				<div class="col-sm-6">
					<div class="input-group">
						...
						<input name="startDate" class="require input-item form-control" data-opt="{type:'date'}">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">完成日期</span>
						<input name="sendee" class="input-item form-control" data-opt="{type:'date'}"/>
					</div>
				</div>
			</div>
			<div class="row mt10">
				<div class="col-sm-6">
					<div class="input-group">
						...
						<input class="require input-item" name="takeOver" data-opt="{type:'checkbox'}" type="checkbox">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">交办接收人</span>
						<input name="sendee" class="input-item form-control"/>
					</div>
				</div>
			</div>
			<div class="row mt10">
				...
				<div class="col-sm-6">
					<div class="input-group">
						...
						<input class="require input-item" name="finish" data-opt="{type:'checkbox'}" type="checkbox">
					</div>
				</div>
			</div>
			<div class="row mt10">
				<div class="col-sm-12">
					<div class="input-group">
						...
						<textarea name="jobContent" class="input-item form-control require" rows="2"></textarea>
					</div>
				</div>
			</div>
			<div class="row mt10">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var editUI = $('#editPanel').editUI({
			title : "项目主要工作安排摘要",
			baseUrl : "ec/basedata/workschedule",
