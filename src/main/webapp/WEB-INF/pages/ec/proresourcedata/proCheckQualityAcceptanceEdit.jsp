				...
				<div class="col-sm-6">
					<div class="input-group">
						...
						<input name="group" class="require input-item form-control" 
							data-opt="{type:'f7',uiWin:{title:'资料目录',height:600,width:300,url:'base/datagroupF7',uiParams:{code:'jypzlysb'}}}" />
					</div>
				</div>
				<div class="col-sm-6">
					<div class="input-group">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		editUI = $('#editPanel').editUI({
			title : "项目检验批质量验收",
			baseUrl : "ec/proresourcedata/procheckqualityacceptance",
