				...
				<div class="col-sm-6">
					<div class="input-group">
						...
						<input name="resourceItem" class="require input-item form-control" 
							data-opt="{type:'f7',dataChange:resourceItem_dataChange,uiWin:{title:'安全技术要求及验收目录',height:570,width:900,url:'ec/basedata/resourceitemF7',uiParams:{type:'AQJSYQYSML'}}}" />
					</div>
				</div>
				<div class="col-sm-6">
					<div class="input-group">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		editUI = $('#editPanel').editUI({
			title : "安全技术要求及验收目录",
			baseUrl : "ec/proresourceitem/skillresourceitem",
