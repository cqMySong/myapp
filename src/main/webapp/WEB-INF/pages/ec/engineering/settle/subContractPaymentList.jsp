...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'分包结算',width:900,height:570};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/engineering/subcontractpayments',title:'项目工程',height:height,
