	     ...
	     <table id="tblMain">
			 <thead >
				<tr>
					...
					<th data-field="rewardPunish" data-type="select">奖惩类型</th>
...
$(document).ready(function() {
	var editWin ={title:'奖惩类别',width:620,height:360};
	var height = top.getTopMainHeight()-45;
	listUI = $('#listPanel').listUI({tableEl:'#tblMain',listModel:1,baseUrl:'ec/other/rewardpunishtypes'
