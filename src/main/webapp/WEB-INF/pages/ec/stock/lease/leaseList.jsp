...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'周转材料、设备使用(出租)',width:1200,height:600};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/stock/leases',title:'项目工程',height:height,
