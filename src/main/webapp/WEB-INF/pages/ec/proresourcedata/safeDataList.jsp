	...
	<div id="table-toolbar" class="panel" style="height:40px;padding-top: 1px;margin-bottom: 5px;">
		<div class="btn-group">
			<button class="btn btn-success" type="button" id="batchimp">
				<span class="fa fa-file-o"></span>&nbsp;安全资料目录导入</button>
		</div>
	</div>
...
$(document).ready(function() {
     ...
     var editWin ={title:'安全资料目录',width:620,height:300,id:"prosafedata_tab"};
     var treeOpt = {setting:{data: {
         	simpleData: {enable:true,idKey: "id", pIdKey: "parentId",rootPId: ''}
    	 }}};
     var height =  top.getTopMainHeight()-45;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/proresourcedata/safedatas',title:'工程项目',height:height,
    ...
    $('#batchimp').on('click',function(){
        ...
        var _win = $.extend(true,{},{title:'安全资料目录导入',width:900,height:570,
                ...
                if(layero){
                    if(index==1){
                        ...
                        if(!webUtil.isEmpty(datas)&&datas.length>0){
                            ...
                            webUtil.ajaxData({url:"ec/proresourcedata/safedata/batch/import",data:pams,async:true,success:function(data){
        ...
        _win.url =  webUtil.toUrl('ec/proresourcedata/safedatas/batch/import');
