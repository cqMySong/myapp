...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'项目质量样板',width:1200,height:((height+100)>800?800:(height+100))};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/quality/templates',title:'项目工程',height:height,
			...
			$('#jobRequire').on('click',function(){
                ...
                if(!webUtil.isEmpty(_selRows)&&_selRows.length>0){
                    ...
                    _win.uiParams = {proQualityTemplateId:webUtil.uuIdReplaceID(_thisRowData.id)};
