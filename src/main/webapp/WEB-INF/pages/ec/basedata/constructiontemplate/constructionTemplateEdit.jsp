		...
		<div class="row">
			<div class="col-sm-6">
				<div class="input-group">
					...
					<input class="require input-item" name="engineeringProject">
				</div>
			</div>
			<div class="col-sm-6 mb15">
				<div class="input-group">
					<span class="input-group-addon lable">样板种类</span>
					<input name="templateType" class="input-item form-control">
				</div>
			</div>
		</div>
		<div class="row ">
			<div class="col-sm-12 mb15">
				<div class="input-group">
					...
					<textarea class="require input-item" name="content"></textarea>
				</div>
			</div>
		</div>
		<div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var editUI = $('#editPanel').editUI({
            title : "施工样板清单",
            baseUrl : "ec/basedata/constructiontemplate",
