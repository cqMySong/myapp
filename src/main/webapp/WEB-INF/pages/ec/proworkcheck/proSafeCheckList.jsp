					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="checkType" data-type="select">检查类别</th>
								<th data-field="billState" data-type="select">业务状态</th>
								<th data-field="proManager_name">项目经理</th>
								<th data-field="proSkiller_name">技术负责人</th>
								<th data-field="partAChecker">施工检查员</th>
...
$(document).ready(function() {
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/proworkcheck/prosafechecks',title:'工程项目',height:height,
