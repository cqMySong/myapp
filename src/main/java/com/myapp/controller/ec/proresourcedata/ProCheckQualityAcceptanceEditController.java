...
@Controller
@RequestMapping("ec/proresourcedata/procheckqualityacceptance")
public class ProCheckQualityAcceptanceEditController extends ProResourceDataBaseEditController {
	@Override
