		...
		<div>
			<div class="panel panel-success">
				<div class="panel-heading" style="padding: 13px;">
					<h3 class="panel-title">选择安全技术要求及验收目录</h3>
...
<script type="text/javascript">
    ...
    var treeUrl = 'ec/basedata/resourceitems/showitemtree/AQJSYQYSML';
    $(document).ready(function(){
        leftTreeViewer = $('#allTreeItems').myTreeViewer(null);
        leftTreeViewer.init({title:'安全技术要求及验收目录标准',height:470});
