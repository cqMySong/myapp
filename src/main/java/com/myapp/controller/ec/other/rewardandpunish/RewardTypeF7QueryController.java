 ...
 */
@Controller
@RequestMapping("ec/other/rewardtypeF7")
public class RewardTypeF7QueryController extends BaseF7QueryController {
	...
	public void executeQueryParams(Criteria query) {
		...
		query.add(Restrictions.eq("rewardPunish",RewardPunish.REWARD));
