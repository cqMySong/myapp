		...
		<div>
			<div class="panel panel-success">
				<div class="panel-heading" style="padding: 13px;">
					<h3 class="panel-title">选择原材料检查</h3>
...
<script type="text/javascript">
    ...
    var treeUrl = 'ec/basedata/resourceitems/showitemtree/YCLJC';
    $(document).ready(function(){
        leftTreeViewer = $('#allTreeItems').myTreeViewer(null);
        leftTreeViewer.init({title:'原材料检查标准',height:470});
