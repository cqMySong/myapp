 ...
 */
@Controller
@RequestMapping("ec/engineering/subcontractF7")
public class SubcontractF7QueryController extends BaseF7QueryController {

	@Resource
	public BaseService baseService;
	@Override
	public AbstractBaseService getService() {
		return baseService.newServicInstance(SubcontractInfo.class);
	}
	@Override
	public List<ColumnModel> getDataBinding() {
		List<ColumnModel> cols = super.getDataBinding();
		ColumnModel col  = new ColumnModel("subcontractExpenseType",DataTypeEnum.ENUM,SubcontractExpenseType.class);
