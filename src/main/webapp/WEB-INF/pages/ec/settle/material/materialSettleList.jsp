...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'物料结算',width:1200,height:winHeight>800?800:winHeight};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/settle/materialsettles',title:'项目工程',height:height,
