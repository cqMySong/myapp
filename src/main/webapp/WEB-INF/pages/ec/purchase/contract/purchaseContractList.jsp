...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'采购合同',width:(window.outerWidth-50),height:(window.outerHeight-100)};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/purchase/purchasecontracts',title:'项目工程',height:(height+42),
