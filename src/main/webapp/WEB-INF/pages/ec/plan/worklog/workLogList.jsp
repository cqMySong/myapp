					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="bizDate" data-type="date">填报日期</th>
...
$(document).ready(function() {
     ...
     var editWin ={title:'项目施工日志',width:980,height:730,openType:'MAINTAB',id:"worklog_tab"};
     var treeOpt = {setting:{data: {
         	simpleData: {enable:true,idKey: "id", pIdKey: "parentId",rootPId: ''}
    	 }}};
     var height = 710;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/plan/worklogs',title:'工程项目',height:height,
    	 treeContainer:"#tree_container",editWin:editWin,toolbar:"#table-toolbar",searchParams:{includeChild:true},treeOpt:treeOpt
    	 ,treeNode2QueryProp:treeNode2QueryProp,extendTableOptions:{toolbar:'#tblMain_toolbar',height:650,sortStable:false}});
     thisOrgList.onLoad();
});
