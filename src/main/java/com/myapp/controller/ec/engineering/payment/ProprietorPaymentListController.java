...
@Controller
@RequestMapping("ec/engineering/proprietorpayments")
public class ProprietorPaymentListController extends BaseListController {
    @Resource
    private ProprietorPaymentService proprietorPaymentService;

    @Override
    public String getEditUrl() {
        return "ec/engineering/settle/proprietorPaymentEdit";
    }

    @Override
    public String getListUrl() {
        return "ec/engineering/settle/proprietorPaymentList";
    }
