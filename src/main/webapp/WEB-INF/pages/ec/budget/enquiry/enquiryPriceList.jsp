			...
			<div class="panel" style="margin-bottom: 0px;">
				...
				<div class="panel-body" style="padding: 0px 2px 2px 2px;">
					<table id="tblMain">
						 <thead >
							<tr>
								<th data-field="name">询价名称</th>
								<th data-field="number">询价编号</th>
								<th data-field="project_name">工程项目</th>
								<th data-field="billState" data-type="select">业务状态</th>
								<th data-field="createUser_name">询价人</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'预算询价',width:(window.outerWidth-50),height:winHeight>800?800:winHeight};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/budget/enquiryprices',title:'项目工程',height:height,
