...
$(document).ready(function() {
     ...
     var editWin ={title:'到访车辆记录',width:620,height:500};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/projects/projectTree'
    	 ,baseUrl:'ec/basedata/carvisitrecords',height:height,treeContainer:"#tree_container",title:"工程项目"
