	...
	<div id="listPanel" class="panel">
		<div id="table-toolbar">
	     ...
	     <table id="tblMain">
			 <thead >
				<tr>
					<th data-field="orgUnit">受惩罚单位</th>
					...
					<th data-field="expirationDate" data-type="date">截止日期</th>
...
$(document).ready(function() {
	var editWin ={title:'惩罚通知单',width:620,height:460};
	var height = top.getTopMainHeight()-45;
	listUI = $('#listPanel').listUI({tableEl:'#tblMain',listModel:1,baseUrl:'ec/other/punishs'
