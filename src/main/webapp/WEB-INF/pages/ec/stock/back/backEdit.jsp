		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="input-group">
					...
					<input name="materialLeaseInfo" class="input-item form-control require "
					   data-opt="{type:'f7',dataChange:selectMaterial,uiWin:{title:'材料周转、租用信息',height:550,width:750,url:'ec/stock/leaseF7'}}"/>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="input-group">
					<span class="input-group-addon lable">材料名称</span>
					<input name="materialInfo" class="input-item form-control require read"  data-opt="{type:'f7'}"/>
				</div>
			</div>
		...
		<div class="row mt10">
			...
			<div class="col-sm-4">
				<div class="input-group">
					...
					<input name="backCount" class="require input-item form-control" type="number"/>
				</div>
			</div>
		</div>
		<div class="row mt10">
			<div class="col-sm-4">
				<div class="input-group">
					...
					<input class="require input-item read" name="leaseUnit">
				</div>
			</div>
			<div class="col-sm-4">
				<div class="input-group">
...
<script type="text/javascript">
    ...
    function selectMaterial(oldData,newData){
        if(newData){
            $("input[name='measureUnitInfo']").myF7().setData({id:newData.measureUnitInfo_id,name:newData.measureUnitInfo_name});
            $("input[name='materialInfo']").myF7().setData({id:newData.materialInfo_id,name:newData.materialInfo_name});
            $("input[name='materialLeaseInfo']").myF7().setData({id:newData.id,name:newData.number});
            $("input[name='leaseUnit']").val(newData.leaseUnit);
        }
    }
