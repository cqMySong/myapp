					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="labourGroup">名称</th>
...
$(document).ready(function() {
     ...
     var editWin ={title:'项目民工工资表',openType:'MAINTAB',id:"prolabourwage_tab"};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree'
    	 ,baseUrl:'ec/labour/prolabourwages',title:'工程项目',height:height,
