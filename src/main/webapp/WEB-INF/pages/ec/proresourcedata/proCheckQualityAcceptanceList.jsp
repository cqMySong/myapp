...
$(document).ready(function() {
     ...
     var editWin ={title:'项目检验批质量验收',width:620,height:300,id:"prosafedata_tab"};
     var treeOpt = {setting:{data: {
         	simpleData: {enable:true,idKey: "id", pIdKey: "parentId",rootPId: ''}
    	 }}};
     var height =  top.getTopMainHeight()-45;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/proresourcedata/procheckqualityacceptances',title:'工程项目',height:height,
