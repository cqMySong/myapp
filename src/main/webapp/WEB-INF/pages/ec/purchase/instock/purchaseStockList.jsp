					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="name">入库说明</th>
								<th data-field="number">入库单号</th>
								<th data-field="inStockDate" data-type="date">收货日期</th>
								<th data-field="consignee_name">收货人</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'采购入库',width:1200,height:winHeight>800?800:winHeight};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/purchase/purchasestocks',title:'项目工程',height:height,
    ...
    function changeBgColor(row,index){
        var color = "";
        var days = webUtil.betweenDateDays(row.inStockDate,row.createDate);
        if(days>2&&days<10){
