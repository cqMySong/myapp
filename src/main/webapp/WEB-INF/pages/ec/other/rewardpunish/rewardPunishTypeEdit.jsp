	...
	<div id="editPanel" class="panel">
		...
		<form id="editForm">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="input-group">
						<span class="input-group-addon lable">奖惩类型</span>
						<select id="rp" name="rewardPunish" class="require input-item form-control" 
							data-opt="{type:'select',url:'base/common/combox?enum=com.myapp.enums.ec.RewardPunish'}" >
						</select>
					</div>
				</div>
				<div class="col-sm-6 mb15">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var editUI = $('#editPanel').editUI({
			title : "奖惩类别",
			baseUrl : "ec/other/rewardpunishtype",
