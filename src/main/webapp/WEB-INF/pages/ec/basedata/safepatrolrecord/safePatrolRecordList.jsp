					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="patrolDate" data-type="date">巡查时间</th>
								<th data-field="range">线路及范围</th>
								<th data-field="attention" data-type="textarea">注意事项</th>
								<th data-field="hasQuestion" data-type="checkbox">异常</th>
								<th data-field="doWay" data-type="select">处理办法</th>
...
$(document).ready(function() {
     ...
     var editWin ={title:'安保巡查记录',width:620,height:450};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/projects/projectTree'
    	 ,baseUrl:'ec/basedata/safepatrolrecords',height:height,treeContainer:"#tree_container",title:"工程项目"
