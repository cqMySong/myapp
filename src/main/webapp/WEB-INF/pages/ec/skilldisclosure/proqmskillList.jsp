...
$(document).ready(function() {
    ...
    $('#batchimp').on('click',function(){
        ...
        */
        ...
        var _win = $.extend(true,{},{title:'施工技术交底导入',width:900,height:570,
                ...
                if(layero){
                    if(index==1){
                        ...
                        if(!webUtil.isEmpty(datas)&&datas.length>0){
                            ...
                            webUtil.ajaxData({url:"ec/skilldisclosure/proqmskill/batch/import",data:pams,async:true,success:function(data){
                                var statusCode = $(data).attr('statusCode');
                                if(0==statusCode){
                                    var msg = $(data).attr('statusMesg');
                                    if(!webUtil.isEmpty(msg)){
