...
<script type="text/javascript">
    ...
    function initTable(){
        ...
        deptManagerGrid.refreshData("ec/purchase/applymaterial/audit/query/data?type=technical&businessKey="+webUtil.uuIdReplaceID(businessKey));
    }
    $(function(){
        var height = top.getTopMainHeight();
