					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="part">部位</th>
								<th data-field="content" data-width="350" data-type="textarea">隐患内容</th>
								<th data-field="secCase" data-width="350" data-type="textarea">安保办法</th>
...
$(document).ready(function() {
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/projects/projectTree'
    	 ,baseUrl:'ec/basedata/prosecuritycases',height:height,treeContainer:"#tree_container",title:"工程项目"
