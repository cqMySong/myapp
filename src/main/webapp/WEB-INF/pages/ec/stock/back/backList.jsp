					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="materialInfo_name">材料、设备名称</th>
								<th data-field="measureUnitInfo_name">单位</th>
								<th data-field="materialLeaseInfo_leaseUnit">出租单位</th>
								<th data-field="backDate" data-type="date">出租时间</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var editWin ={title:'周转材料、设备使用(归还)',width:800,height:460};
			var treeOpt = {
					setting:{
						data: {
			...
			thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/stock/backs',title:'项目工程',height:(height+42),
