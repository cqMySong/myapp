...
<body style="padding: 5px;">
	<div id="table-toolbar" class="panel" style="height:60px;margin-bottom:5px;overflow: visible;"></div>
					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="billState">业务状态</th>
...
$(document).ready(function() {
     ...
     var editWin ={title:'项目总计划',width:980,height:730,openType:'MAINTAB',id:"projecttotalplans_tab"};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',treeUrl:'ec/basedata/projects/projectTree',baseUrl:'ec/plan/projecttotalplans',title:'工程项目',height:height,
    	 treeContainer:"#tree_container",editWin:editWin,hasDefToolbar:false,toolbar:"#table-toolbar",searchParams:{includeChild:true},treeOpt:treeOpt
