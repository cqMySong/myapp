...
function beforeAction(opt){
	if(opt=='addnew'){
		...
		if(!webUtil.isEmpty(params)&&!webUtil.isEmpty(params.tree)
			...
			webUtil.mesg('请先选择具体是施工技术分类标准，然后才能做新增操作!');
			return false;
		}
	}
	return true;
...
$(document).ready(function() {
     ...
     var editWin ={title:'施工技术交底清单',width:620,height:320};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/skillclasss/treeData'
    	 ,baseUrl:'ec/basedata/qmskillitems',title:'施工技术分类',height:height,
