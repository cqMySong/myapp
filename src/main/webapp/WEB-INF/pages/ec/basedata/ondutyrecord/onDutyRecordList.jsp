					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="dutyDate" data-type="datetime">值班时间</th>
								<th data-field="dutyPosition">安保岗位</th>
								<th data-field="planDutyor">计划值班人员</th>
								<th data-field="realDutyor">实际值班人员</th>
								<th data-field="content" data-type="textarea">交接事项</th>
...
$(document).ready(function() {
     ...
     var editWin ={title:'安保人员值班安排及值班记录',width:620,height:420};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/projects/projectTree'
    	 ,baseUrl:'ec/basedata/ondutyrecords',height:height,treeContainer:"#tree_container",title:"工程项目"
