					...
					<table id="tblMain">
						 <thead >
							<tr>
								...
								<th data-field="checkDate" data-type="date">值班时间</th>
								<th data-field="position">检查岗位</th>
								<th data-field="content" data-type="select">检查内容</th>
								<th data-field="question">存在问题</th>
...
$(document).ready(function() {
     ...
     var editWin ={title:'安保监督检查记录',width:620,height:450};
     ...
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/projects/projectTree'
    	 ,baseUrl:'ec/basedata/safecheckrecords',height:height,treeContainer:"#tree_container",title:"工程项目"
