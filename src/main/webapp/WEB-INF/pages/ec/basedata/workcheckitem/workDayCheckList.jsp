...
$(document).ready(function() {
     ...
     var editWin ={title:'施工现场日检查项目',width:620,height:360};
     var treeOpt = {setting:{data: {
         	simpleData: {enable:false,idKey: "id"}
    	 }}};
     var height = top.getTopMainHeight()-45;
     thisOrgList = $('body').treeListUI({tableEl:'#tblMain',listModel:1,treeUrl:'ec/basedata/workdaychecks/treeData'
    	 ,baseUrl:'ec/basedata/workdaychecks',title:'施工现场检查类别',height:height,
